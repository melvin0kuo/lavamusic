...
var import_topgg_autoposter = require("topgg-autoposter");
...
var Ready = class extends Event {
  ...
  async run() {
    ...
    if (env.TOPGG) {
      const autoPoster = (0, import_topgg_autoposter.AutoPoster)(env.TOPGG, this.client);
      setInterval(() => {
