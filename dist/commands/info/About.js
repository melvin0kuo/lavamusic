...
// src/commands/info/About.ts
var About = class extends Command {
  static {
    __name(this, "About");
  }
  constructor(client) {
  ...
  async run(client, ctx) {
    const inviteButton = new import_discord6.ButtonBuilder().setLabel(ctx.locale("buttons.invite")).setStyle(import_discord6.ButtonStyle.Link).setURL(`https://discord.com/api/oauth2/authorize?client_id=${client.env.CLIENT_ID}&permissions=8&scope=bot%20applications.commands`);
    const supportButton = new import_discord6.ButtonBuilder().setLabel(ctx.locale("buttons.support")).setStyle(import_discord6.ButtonStyle.Link).setURL("https://discord.gg/YQsGbTwPBx");
    const row = new import_discord6.ActionRowBuilder().addComponents(inviteButton, supportButton);
    ...
    }).setThumbnail("https://media.discordapp.net/attachments/876035356460462090/888434725235097610/20210820_124325.png").setColor(this.client.color.main).addFields({
