...
// src/commands/playlist/Create.ts
var Create_exports = {};
...
// src/commands/playlist/Create.ts
var CreatePlaylist = class extends Command {
  static {
    __name(this, "CreatePlaylist");
  }
  constructor(client) {
    super(client, {
      name: "create",
  ...
  async run(client, ctx, args) {
    ...
    if (name.length > 50) {
      return await ctx.sendMessage({
        embeds: [
          embed.setDescription(ctx.locale("cmd.create.messages.name_too_long")).setColor(this.client.color.red)
        ]
      });
    }
    ...
    return await ctx.sendMessage({
      embeds: [
        embed.setDescription(ctx.locale("cmd.create.messages.playlist_created", {
          name
