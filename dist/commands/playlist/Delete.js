...
// src/commands/playlist/Delete.ts
var DeletePlaylist = class extends Command {
  static {
    __name(this, "DeletePlaylist");
  }
  constructor(client) {
    super(client, {
      name: "delete",
  ...
  async run(client, ctx, args) {
    ...
    return await ctx.sendMessage({
      embeds: [
        embed.setDescription(ctx.locale("cmd.delete.messages.playlist_deleted", {
          playlistName
