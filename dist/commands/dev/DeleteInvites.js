...
var DeleteInvites_exports = {};
__export(DeleteInvites_exports, {
  default: () => DestroyInvites
});
module.exports = __toCommonJS(DeleteInvites_exports);
...
// src/commands/dev/DeleteInvites.ts
var DestroyInvites = class extends Command {
  static {
    __name(this, "DestroyInvites");
  }
  constructor(client) {
    super(client, {
      name: "destroyinvites",
      description: {
        ...
        examples: [
          "destroyinvites 0000000000000000000"
        ],
