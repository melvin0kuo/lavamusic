...
// src/commands/music/FairPlay.ts
var FairPlay_exports = {};
__export(FairPlay_exports, {
  default: () => FairPlay
});
module.exports = __toCommonJS(FairPlay_exports);
...
__name(applyFairPlayToQueue, "applyFairPlayToQueue");

// src/commands/music/FairPlay.ts
var FairPlay = class extends Command {
  static {
    __name(this, "FairPlay");
  }
  constructor(client) {
    super(client, {
      name: "fairplay",
  ...
  async run(client, ctx) {
    ...
    let fairPlay = player.get("fairplay");
