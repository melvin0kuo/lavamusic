...
// src/commands/music/ClearQueue.ts
var ClearQueue_exports = {};
__export(ClearQueue_exports, {
  default: () => ClearQueue
});
module.exports = __toCommonJS(ClearQueue_exports);
...
// src/commands/music/ClearQueue.ts
var ClearQueue = class extends Command {
  static {
    __name(this, "ClearQueue");
  }
  constructor(client) {
    super(client, {
      name: "clearqueue",
  ...
  async run(client, ctx) {
    ...
    if (!player) {
      return await ctx.sendMessage({
        embeds: [
          embed.setColor(this.client.color.red).setDescription(ctx.locale("player.errors.no_player"))
        ]
      });
    }
    ...
    return await ctx.sendMessage({
      embeds: [
        embed.setColor(this.client.color.main).setDescription(ctx.locale("cmd.clearqueue.messages.cleared"))
      ]
    });
  }
};
