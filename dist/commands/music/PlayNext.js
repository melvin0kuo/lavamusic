...
// src/commands/music/PlayNext.ts
var PlayNext_exports = {};
__export(PlayNext_exports, {
  default: () => PlayNext
});
module.exports = __toCommonJS(PlayNext_exports);
...
// src/commands/music/PlayNext.ts
var PlayNext = class extends Command {
  static {
    __name(this, "PlayNext");
  }
  constructor(client) {
    super(client, {
      name: "playnext",
  ...
  async run(client, ctx, args) {
    ...
    if (!response || response.tracks?.length === 0) {
      return await ctx.editMessage({
        content: "",
        embeds: [
          embed.setColor(this.client.color.red).setDescription(ctx.locale("cmd.play.errors.search_error"))
        ]
      });
    }
    ...
    if (response.loadType === "playlist") {
      await ctx.editMessage({
        content: "",
        embeds: [
          embed.setColor(this.client.color.main).setDescription(ctx.locale("cmd.playnext.added_playlist_to_play_next", {
