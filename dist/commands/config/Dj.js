...
// src/commands/config/Dj.ts
var Dj_exports = {};
__export(Dj_exports, {
  default: () => Dj
});
module.exports = __toCommonJS(Dj_exports);
  ...
  async run(client, ctx, args) {
    ...
    switch (subCommand) {
      ...
      case "clear": {
        ...
        return ctx.sendMessage({
          embeds: [
            embed.setDescription(ctx.locale("cmd.dj.messages.all_roles_cleared"))
          ]
        });
      }
      case "toggle": {
