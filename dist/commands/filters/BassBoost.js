...
// src/commands/filters/BassBoost.ts
var BassBoost_exports = {};
__export(BassBoost_exports, {
  default: () => BassBoost
});
module.exports = __toCommonJS(BassBoost_exports);
var import_discord6 = require("discord.js");
var import_lavalink_client2 = require("lavalink-client");
...
// src/commands/filters/BassBoost.ts
var BassBoost = class extends Command {
  static {
    __name(this, "BassBoost");
  }
  constructor(client) {
    super(client, {
      name: "bassboost",
      ...
      options: [
        {
          ...
          type: import_discord6.ApplicationCommandOptionType.String,
          required: true,
          choices: [
            {
              name: "high",
  ...
  async run(client, ctx) {
    ...
    switch (ctx.args[0]?.toLowerCase()) {
      case "high": {
        await player.filterManager.setEQ(import_lavalink_client2.EQList.BassboostHigh);
      ...
      case "medium": {
        await player.filterManager.setEQ(import_lavalink_client2.EQList.BassboostMedium);
        await ctx.sendMessage({
          embeds: [
            {
      ...
      case "low": {
        await player.filterManager.setEQ(import_lavalink_client2.EQList.BassboostLow);
        await ctx.sendMessage({
          embeds: [
            {
