...
// src/commands/filters/NightCore.ts
var NightCore_exports = {};
__export(NightCore_exports, {
  default: () => NightCore
});
module.exports = __toCommonJS(NightCore_exports);
...
// src/commands/filters/NightCore.ts
var NightCore = class extends Command {
  static {
    __name(this, "NightCore");
  }
  constructor(client) {
    super(client, {
      name: "nightcore",
